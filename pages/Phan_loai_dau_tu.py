...
st.markdown("<h4 style='color:#0f172a; background-color:#ffffff; padding:10px; border-radius:8px; display:inline-block; margin-top:20px;'>(B) Dòng tiền theo ngày (1 năm)</h4>", unsafe_allow_html=True)
...
# Gợi ý dựa trên Z-Score tổng hợp sức khỏe (health_z)
